    ...
    <div className="space-y-4 pb-28 pt-1">
      ...
      {activeTab === 'geral' ? (
        <>
          ...
          {/* Stats Grid 2x2 - Indicadores financeiros */}
          ...
          <section className="grid grid-cols-3 gap-2">
            <div className="bg-card border border-border rounded-[16px] p-3 text-center shadow-sm">
          ...
          {/* % Combustível */}
          <section className="bg-card border border-border rounded-[20px] p-3.5 space-y-2">
            ...
            <div className="flex justify-between text-[9px] font-bold text-muted">
              <span>R$ {fuelExpenses.toFixed(0)} em combustível</span>
              <span>R$ {totalExpenses.toFixed(0)} total gastos</span>
            </div>
          </section>
          ...
          {/* Ranking de Ganhos por Plataforma */}
              ...
              <div className="space-y-1.5">
                ...
                <div className="w-full bg-card-secondary h-1.5 rounded-full overflow-hidden">
                  <div 
                    ...
                    style={{ 
                      width: `${dailyGoal > 0 ? Math.min((netProfit / dailyGoal) * 100, 100) : 0}%`,
                      backgroundColor: dailyGoal > 0
                        ? (netProfit / dailyGoal) >= 1 ? '#10B981'
                          : (netProfit / dailyGoal) >= 0.7 ? '#22C55E'
                          : (netProfit / dailyGoal) >= 0.4 ? '#F59E0B'
                          : '#EF4444'
                        : '#71717A'
                    }}
                  />
                </div>
                <div className="text-[9px] text-muted font-semibold">R$ {netProfit.toFixed(0)} / R$ {dailyGoal.toFixed(0)}</div>
              </div>
              {/* Meta Semanal */}
              <div className="space-y-1.5">
                <div className="flex justify-between text-[11px] font-bold text-foreground items-center">
                ...
                <div className="text-[9px] text-muted font-semibold">R$ {weekNetProfit.toFixed(0)} / R$ {weeklyGoal.toFixed(0)}</div>
              </div>
              {/* Meta Mensal */}
              <div className="space-y-1.5">
                <div className="flex justify-between text-[11px] font-bold text-foreground items-center">
                ...
                <div className="text-[9px] text-muted font-semibold">R$ {monthNetProfit.toFixed(0)} / R$ {monthlyGoal.toFixed(0)}</div>
              </div>
            </div>
          </section>
        </>
